        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AddressCustomer_Customers_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactCustomer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContactCustomer_Contacts_ContactId",
                        column: x => x.ContactId,
                        principalTable: "Contacts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactCustomer_Customers_Id",
                        column: x => x.Id,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AddressStore_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AddressStore_Stores_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactStore", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContactStore_Contacts_ContactId",
                        column: x => x.ContactId,
                        principalTable: "Contacts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactStore_Stores_Id",
                        column: x => x.Id,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddressCustomer_AddressId",
                table: "AddressCustomer",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_AddressStore_AddressId",
                table: "AddressStore",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactCustomer_ContactId",
                table: "ContactCustomer",
                column: "ContactId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactStore_ContactId",
                table: "ContactStore",
                column: "ContactId");
